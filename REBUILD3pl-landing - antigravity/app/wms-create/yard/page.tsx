...
export default function WMSYardPage() {
          ...
          <div className="bg-white p-4 border border-gray-200 flex flex-col">
            <div className="flex items-center justify-between mb-3 flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-black">Yard Management</h2>
                  <p className="text-gray-600 font-medium text-xs">Dock Door & Trailer Tracking</p>
                </div>
              </div>
